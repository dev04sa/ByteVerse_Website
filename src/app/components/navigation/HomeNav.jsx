...
const HomeNavigation = () => {
  ...
  if (isMobile) {
    return (
      <div className="w-full flex top-0 mx-6 z-[100] items-center justify-center fixed">
        <div
          hidden={!isOpen}
          className="h-[140vh] w-[100vw] fixed top-0 bg-[#54191962]"
          style={{ zIndex: "110" }}
        >
          <HomeSidebar toggle={toggle} open={isOpen} />
          <div
            className="absolute right-0 h-[140vh] w-[100vw] "
            hidden={!isOpen}
            onClick={toggle}
          ></div>
        </div>
        ...
        <button
          ...
          } cursor-pointer md:hidden block absolute active:invert left-0 ml-8 mt-8 top-0 transition-all duration-150`}
          onClick={toggle}
          style={{ zIndex: "250" }}
        >
